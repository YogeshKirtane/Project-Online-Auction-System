...
public class AdvertController {
	...
	public String newAuction(@RequestParam(value="name", required=false) String name, @RequestParam(value="description", required=false) String description, @RequestParam(value="startingPrice", required=false) Double startingPrice,@RequestParam MultipartFile image, @RequestParam(value="advertCategory", required=false) Integer idAdvertCategory, HttpServletRequest request) {
